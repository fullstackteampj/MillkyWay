...
<body>
	<div id="wrap">
		<header>
			<nav>
				<ul>
					<li class="on"><a href="#">등록</a></li>
					<li><a href="/admin/update">수정</a></li>
					<li><a href="/admin/delete">삭제</a></li>
				</ul>
			</nav>
			...
			<form >
				...
				<ul>
					<li>
						...
						<input type="text" name="contents" id="contents" placeholder="4-5줄 정도 분량"/>
					</li>
					
					<li>
						<label for="authorIntro">저자 소개</label><br />
						<input type="text" name="authorIntro" id="authorIntro" placeholder="2-3줄 정도 분량"/>
					</li>
					
					<li>
						<label for="contentsTables">목차</label><br />
						<input type="text" name="contentsTables" id="contentsTables" placeholder="1. 2. 3. 형식으로 작성"/>
					</li>
					
					<li>
						<label for="miniIntro">간단 소개글</label><br />
						<input type="text" name="miniIntro" id="miniIntro" placeholder="2-3줄 정도 분량"/>
					</li>
				</ul>
