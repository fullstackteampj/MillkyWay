  ...
  <div id="wrap">
    ...
    <section class="login">
      ...
      <form name="loginFrm" method="post" action="/procs/loginProc">
        ...
        <%
        String clientId = EnvConfig.required("NAVER_LOGIN_CLIENT_ID");
        String redirectUriValue = EnvConfig.optional(
            "NAVER_LOGIN_REDIRECT_URI",
            "http://localhost:8080/login/naverLogin"
        );
        String redirectURI = URLEncoder.encode(redirectUriValue, "UTF-8");
        ...
        <a class="naver" href="<%=apiURL%>">
            <img height="50" src="${pageContext.request.contextPath}/images/btnG_완성형.png" alt="네이버 로그인"/>
        </a>
