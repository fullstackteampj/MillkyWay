...
<%
//페이징 기법
	int totalRecord = myMgr.getTotalPurCount(Integer.parseInt(userId)); // 전체 레코드 수
	// int totalRecord = 51;
  ...
  <div id="wrap">
    ...
    <section class="myPage01">
      ...
      <div class="mainContainer">
        ...
        <ul class="buyList">
        <%
        Vector<PurchaseBean> purList = myMgr.getPurList(Integer.parseInt(userId), start, end);
